...
if __name__=='__main__':
    ...
    while True:
        ...
        if "stop" in statement or "exit" in statement:
            ...
            print("A warm" + statement)
            speak("A warm" + statement)
            print("How are you Mister")
        ...
        elif "write a note" in statement or "take notes" in statement:
            takenotes()

        elif "show notes" in statement or "display notes" in statement or "tasks" in statement:
            speak("Showing Notes")
        ...
        elif "will you be my girlfriend" in statement or "will you be my boyfriend" in statement or "will you be my" in statement:
            ...
            print("Get yourself a girlfriend it's not good to flirt with an assistant")
